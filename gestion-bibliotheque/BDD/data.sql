...
INSERT INTO users (name, email, password, profile, role_id, active)
VALUES
  ('Admin Bibliothèque', 'admin@bib.mg', 'admin123', 'BIBLIOTHECAIRE', 1, true),
  ('Jean Etudiant', 'jean@etud.mg', 'pass123', 'ETUDIANT', 2, true),
  ('Marie Pro', 'marie@pro.mg', 'pass456', 'PROFESSIONNEL', 2, true);
...
(1, true, true, 15, 'DOMICILE', 4, 2, 1, 'ETUDIANT'),
(2, true, true, 30, 'DOMICILE', 6, 3, 1, 'PROFESSEUR'),
(3, true, true, 21, 'DOMICILE', 5, 2, 2, 'PROFESSIONNEL'),
(4, false, false, 0, 'SUR_PLACE', 1, 0, 0, 'ANONYME'),
(5, true, true, 45, 'DOMICILE', 10, 4, 0, 'BIBLIOTHECAIRE');
