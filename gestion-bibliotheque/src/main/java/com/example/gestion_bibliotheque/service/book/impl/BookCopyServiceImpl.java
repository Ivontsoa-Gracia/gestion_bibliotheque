...
public class BookCopyServiceImpl implements BookCopyService {
    ...
    @Override
    public long countTotalCopiesByBookId(Long bookId) {
        return bookCopyRepository.countByBookId(bookId);
    }

    @Override
    public long countAvailableCopiesByBookId(Long bookId) {
        return bookCopyRepository.countByBookIdAndStatus(bookId, CopyStatus.DISPONIBLE);
    }
    ...
    @Override
    public List<BookCopy> getAllCopyByIdBook(Long bookId) {
