...
import com.example.gestion_bibliotheque.dto.book.BookWithCopiesDTO;
...
//    liste avec les details des copies
    ...
    @GetMapping("/{id}/with-copies")
    public BookWithCopiesDTO getBookWithCopies(@PathVariable Long id) {
        return bookService.getBookWithCopies(id);
    }
